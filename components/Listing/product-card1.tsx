import { Price, PriceValue } from "@/components/Listing/price";
...
const ProductCard1 = ({ className }: ProductCard1Props) => {
  ...
  return (
    <a
      ...
      className={cn(
        "block max-w-md transition-opacity hover:opacity-80 border-2 rounded-lg border-gray-200",
        className,
      )}
    >
      <Card className="h-full overflow-hidden p-0 border border-2 rounded-lg border-gray-200">
